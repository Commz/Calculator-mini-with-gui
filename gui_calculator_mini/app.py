...
def final_op():
    ...
    global cur_num2
    global final_num
    int_store_num = int(store_num)
    int_cur_num2 = int(cur_num2)
...
button0 = tk.Button(frame, text="0", bg="lightgrey", fg="black", font=40, command= num0)
...
button1 = tk.Button(frame, text="1", bg="lightgrey", fg="black", font=40, command= num1)
button1.place(relx=0, rely=0.6, relwidth=0.25, relheight=0.2)
# button for the number 1

button2 = tk.Button(frame, text="2", bg="lightgrey", fg="black", font=40, command= num2)
button2.place(relx=0.25, rely=0.6, relwidth=0.25, relheight=0.2)
#button for the number 2

button3 = tk.Button(frame, text="3", bg="lightgrey", fg="black", font=40, command= num3)
button3.place(relx=0.50, rely=0.6, relwidth=0.25, relheight=0.2)
#button for the number 3

button4 = tk.Button(frame, text="4", bg="lightgrey", fg="black", font=40, command= num4)
button4.place(relx=0, rely=0.4, relwidth=0.25, relheight=0.2)
#button for the number 4

button5 = tk.Button(frame, text="5", bg="lightgrey", fg="black", font=40, command= num5)
button5.place(relx=0.25, rely=0.4, relwidth=0.25, relheight=0.2)
#button for the number 5

button6 = tk.Button(frame, text="6", bg="lightgrey", fg="black", font=40, command= num6)
button6.place(relx=0.5, rely=0.4, relwidth=0.25, relheight=0.2)
#button for the number 6

button7 = tk.Button(frame, text="7", bg="lightgrey", fg="black", font=40, command= num7)
button7.place(relx=0, rely=0.2, relwidth=0.25, relheight=0.2)
#button for the number 7

button8 = tk.Button(frame, text="8", bg="lightgrey", fg="black", font=40, command= num8)
button8.place(relx=0.25, rely=0.2, relwidth=0.25, relheight=0.2)
#button for the number 8

button9 = tk.Button(frame, text="9", bg="lightgrey", fg="black", font=40, command= num9)
